...
const ShtoMesimdhenesinModal = ({ showModal, closeModal }) => {
    ...
    const handleShtoClick = async () => {
        try {
          ...
          toast.success('Mesimdhenesi u shtua me sukses', { autoClose: 1500 });
          setTimeout(() => {
            closeModal();
...
export default ShtoMesimdhenesinModal;
